...
<head>
    ...
    <link rel="stylesheet" href="/css/theme273.min.css">
        ...
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('添加文章','article_add.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加文章</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('标签列表','label_list.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>标签列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('添加标签','label_add.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加标签</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="草稿管理">&#xe723;</i>
                    <cite>草稿管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('日志列表','admin-list.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>日志列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('基本信息设置','unicode.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>基本信息设置</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="回收站管理">&#xe6ce;</i>
                    <cite>回收站管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('回收站列表','echarts1.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>回收站列表</cite></a>
                    </li>
                </ul>
