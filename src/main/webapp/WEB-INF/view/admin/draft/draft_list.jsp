                    ...
                    <table class="layui-table layui-form">
                        ...
                        <c:forEach items="${pageInfo.list}" var="c" varStatus="st">
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="id" value="${c.draftId}"   lay-skin="primary">
                                </td>
                                <td>${c.draftId}</td>
                                <td>${c.draftTitle}</td>
                                <td>${c.draftCreateTime}</td>
                                <td class="td-manage">
                                    <a title="修改分类" href='/draft_edit.html?id=${c.draftId}'>
                                        <i class="layui-icon">&#xe631;</i>
                                    </a>
                                    <a title="删除" onclick="member_del(this,${c.draftId})" href="javascript:;">
                                        <i class="layui-icon">&#xe640;</i>
                                    </a>
                                </td>
                            </tr>
